  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 dark:bg-black dark:text-white p-6">
      ...
      <div className="print-area w-full flex flex-col items-center">
        <div className="bg-white dark:bg-gray-900 shadow-2xl rounded-xl border-4 border-yellow-500 dark:border-yellow-600 p-10 text-center max-w-2xl w-full">
          <h1 className="text-4xl font-bold text-blue-600 dark:text-blue-400 uppercase tracking-wide">
            {isPassed ? "Certificate of Completion" : "Certificate of Participation"}
          </h1>
          ...
          <p className="text-lg mt-2 dark:text-gray-300">
            for {isPassed ? "successfully completing" : "participating in"} the test with a score of{" "}
            {score}/{total} ({percentage}%).
          </p>

          {!isPassed && (
            <p className="mt-4 text-red-500 font-medium">
              Keep learning and try again. We believe in your potential!
            </p>
          )}
      ...
      <button
        ...
        className="no-print mt-6 bg-blue-500 dark:bg-blue-600 text-white py-2 px-6 rounded-lg shadow-md hover:bg-blue-600 dark:hover:bg-blue-700 transition"
      >
        Print Certificate
      </button>
    </div>
