  ...
  //     setLoading(true);
  //     try {
  //       const response = await axios.post("https://eduwebbackend.onrender.com/api/auth/login", {
  //         email,
  //         password,
  //       });
  ...
  //     setLoading(true);
  //     try {
  //       const response = await axios.post("https://eduwebbackend.onrender.com/api/auth/signup", {
  //         name,
  //         email,
  //         password,
  //         role,
