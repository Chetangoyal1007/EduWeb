  ...
  //     setLoading(true);
  //     try {
  //       const response = await axios.post("https://eduwebbackend.netlify.app//api/auth/login", {
  //         email,
  //         password,
  //       });
  ...
  //     setLoading(true);
  //     try {
  //       const response = await axios.post("https://eduwebbackend.netlify.app//api/auth/signup", {
  //         name,
  //         email,
  //         password,
  //         role,
