...
//   return (
//     <div className="p-10 max-w-4xl mx-auto text-gray-900 dark:text-white">
...
//       {questions.map((q, i) => (
//         <div key={i} className="border rounded p-5 mb-6 bg-gray-100 dark:bg-gray-800 dark:border-gray-700">
//           <select
//             value={q.type}
//             onChange={(e) => updateQuestion(i, "type", e.target.value)}
//             className="border mb-3 p-2 w-full rounded bg-white dark:bg-gray-700 dark:border-gray-600 dark:text-white"
//           >
//             <option value="mcq">MCQ</option>
//             <option value="coding">Coding</option>
//           </select>
//           <input
//             className="border p-2 w-full mb-3 rounded bg-white dark:bg-gray-700 dark:border-gray-600 dark:text-white"
//             placeholder="Question Text"
//             value={q.text}
//             onChange={(e) => updateQuestion(i, "text", e.target.value)}
//           />
